...
print("")
print("Based on these findings, Otsu's method (and an upper boundary) should be used.")
print("")
...
print("")
print("Based on these findings, contour-finding-based cell counting should be used.")